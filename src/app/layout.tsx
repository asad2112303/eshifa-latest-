...
export const metadata: Metadata = {
  ...
  description:
    "Pakistan's first JCI-accredited home healthcare: laboratory, nursing, rehabilitation, pharmacy, teleconsultation and specialized care programs at home. 24/7 nationwide. UAN: 051-111-111-567.",
  keywords: [
    ...
    "specialized care programs Pakistan",
  ...
  openGraph: {
    ...
    description:
      "Pakistan's first JCI-accredited home healthcare: laboratory, nursing, rehabilitation, pharmacy, teleconsultation and specialized care programs at home.",
    images: [{ url: "/opengraph.jpg", width: 1200, height: 630, alt: "eShifa home healthcare" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Quality Healthcare at Your Doorstep | eShifa Pakistan",
    description: "JCI-accredited home healthcare in Pakistan: nursing, labs, pharmacy, rehab, teleconsult, specialized care programs.",
