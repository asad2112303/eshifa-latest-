...
import { Reveal, PageTransition, AnimatedWords } from "@/motion/components";
...
type AlternatingSection = {
  ...
  slug: ServiceSlug;
  /** Omit when no photograph exists yet — an icon panel is rendered instead. */
  image?: string;
  alt?: string;
  points: string[];
};
    ...
    >
      ...
      <div className={`px-4 sm:px-8 py-3 transition-all duration-300 ${solidNav ? "bg-white shadow-md" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/">
            <img
              src={`${import.meta.env.BASE_URL}eshifa-logo.png`}
              alt="eShifa Logo"
        ...
        >
          {carePrograms.map((program) => (
            ...
            >
              <div className="relative">
                <img
                  src={`${import.meta.env.BASE_URL}images/care-plans/${program.image}`}
                  alt={program.alt}
...
function SiteFrame({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen w-full bg-white text-[#444444] font-sans selection:bg-[#1B004E] selection:text-white">
      <Navbar />
      <main>{children}</main>
      <Footer />
    </div>
...
function ServicesPage() {
  useSeo({
    title: "Home Healthcare Services | eShifa",
    description:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <Reveal direction="left">
              <img
                src={`${import.meta.env.BASE_URL}images/nursing.png`}
    ...
    <>
      ...
      <section className="py-20 bg-[#F5F5F5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <Reveal>
            <img
              src={`${import.meta.env.BASE_URL}images/teleconsultation.png`}
...
function LabsPage() {
  useSeo({
    title: "Lab Centers & Home Lab Tests | eShifa",
    description:
      ...
      <section className="py-20 bg-[#F5F5F5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <Reveal className="lg:order-2">
            <img src={`${import.meta.env.BASE_URL}images/lab.png`} alt="eShifa certified phlebotomist collecting home blood sample in Islamabad" className="rounded-[28px] shadow-xl w-full aspect-[4/3] object-cover" loading="lazy" />
          </Reveal>
...
function InternationalPatientsPage() {
  useSeo({
    title: "International Patients | eShifa",
    description:
...
function AboutPage() {
  useSeo({
    title: "About eShifa | Quality Healthcare at Your Doorstep",
    description:
...
function ContactPage() {
  useSeo({
    title: "Contact eShifa | 24/7 Care Team",
    description:
...
function AnimatedRoutes() {
  ...
  return (
    <SiteFrame>
      ...
      >
        {/* Keyed by location so route changes cross-fade; Switch receives the captured
            location so the exiting page keeps rendering its own route during the exit. */}
        <PageTransition key={location}>
          <Switch location={location}>
            ...
            <Route path="/international" component={InternationalPatientsPage} />
