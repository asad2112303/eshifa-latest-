...
export const siteConfig = {
  ...
  description:
    "Pakistan's first JCI-accredited home healthcare: laboratory, nursing, rehabilitation, pharmacy, teleconsultation and specialized care programs at home. 24/7 nationwide.",
  contact: {
